...
`
	...
	// GetItems
	a = myIni.GetItems("added section")
	sort.Strings(a)
	s = fmt.Sprintf("%v", a)
	...
	// GetSectionComments ///////////////////////////////////////////////////////
	a = myIni.GetSectionComments("section1")
	s = fmt.Sprintf("%v", a)
	...
	a = myIni.GetSectionComments("another new section")
	s = fmt.Sprintf("%v", a)
	...
	// GetItemComments ///////////////////////////////////////////////////////
	a = myIni.GetItemComments("section1", "item1")
	s = fmt.Sprintf("%v", a)
	...
	a = myIni.GetItemComments("another new section", "added item")
	s = fmt.Sprintf("%v", a)
	exceptedComments = fmt.Sprintf("%v", []string{})
	if s != exceptedComments {
	...
	//AddItemComment ///////////////////////////////////////////////////////
	if b = myIni.AddItemComment("rename section", "item2", "un nouveau commentaire"); !b {
		t.Error("For", "AddItemComment(rename section,item2,un nouveau commentaire)", "expected", true, "got", b)
	}
	// GetItemComments
	a = myIni.GetItemComments("rename section", "item2")
	s = fmt.Sprintf("%v", a)
	exceptedComments = fmt.Sprintf("%v", []string{"comment 3", "second line of comments for comment 3", "un nouveau commentaire"})
	if s != exceptedComments {
		t.Error("For", "GetItemComments(rename section,item2)", "expected", exceptedComments, "got", s)
	}
	//AddItemComment
	if b = myIni.AddItemComment("this section does not exists", "item2", "t"); b {
		t.Error("For", "AddItemComment(this section does not exists,item2,t)", "expected", false, "got", b)
	}
	if b = myIni.AddItemComment("does not exists", "does not exists", "t"); b {
		t.Error("For", "AddItemComment(does not exists,does not exists,t)", "expected", false, "got", b)
	}

	// DeleteItemComment ///////////////////////////////////////////////////////
	if b = myIni.DeleteItemComment("rename section", "item2", 2); !b {
		t.Error("For", "DeleteItemComment(rename section,item2,2)", "expected", true, "got", b)
	}
	// GetItemComments
	a = myIni.GetItemComments("rename section", "item2")
	s = fmt.Sprintf("%v", a)
	exceptedComments = fmt.Sprintf("%v", []string{"comment 3", "second line of comments for comment 3"})
	if s != exceptedComments {
		t.Error("For", "GetItemComments(rename section,item2)", "expected", exceptedComments, "got", s)
	}

	// DeleteItemComments ///////////////////////////////////////////////////////
	if b = myIni.DeleteItemComments("rename section", "item2"); !b {
		t.Error("For", "DeleteItemComments(rename section,item2)", "expected", true, "got", b)
	}
	// GetItemComments
	a = myIni.GetItemComments("rename section", "item2")
	s = fmt.Sprintf("%v", a)
	...
	//AddSectionComment ///////////////////////////////////////////////////////
	if b = myIni.AddSectionComment("rename section", "un nouveau commentaire"); !b {
		t.Error("For", "AddItemComment(rename section,un nouveau commentaire)", "expected", true, "got", b)
	}
	// GetSectionComments
	a = myIni.GetSectionComments("rename section")
	s = fmt.Sprintf("%v", a)
	exceptedComments = fmt.Sprintf("%v", []string{"comment with a dot-comma", "second line of comments", "un nouveau commentaire"})
	if s != exceptedComments {
		t.Error("For", "GetSectionComments(rename section)", "expected", exceptedComments, "got", s)
	}
	//AddItemComment
	if b = myIni.AddSectionComment("this section does not exists", "t"); b {
		t.Error("For", "AddItemComment(this section does not exists,t)", "expected", false, "got", b)
	}

	// DeleteSectionComment ///////////////////////////////////////////////////////
	if b = myIni.DeleteSectionComment("rename section", 2); !b {
		t.Error("For", "DeleteSectionComment(rename section,2)", "expected", true, "got", b)
	}
	// GetSectionComments
	a = myIni.GetSectionComments("rename section")
	s = fmt.Sprintf("%v", a)
	exceptedComments = fmt.Sprintf("%v", []string{"comment with a dot-comma", "second line of comments"})
	if s != exceptedComments {
		t.Error("For", "GetSectionComments(rename section)", "expected", exceptedComments, "got", s)
	}

	// DeleteSectionComments ///////////////////////////////////////////////////////
	if b = myIni.DeleteSectionComments("rename section"); !b {
		t.Error("For", "DeleteSectionComments(rename section)", "expected", true, "got", b)
	}
	// GetSectionComments
	a = myIni.GetSectionComments("rename section")
	s = fmt.Sprintf("%v", a)
